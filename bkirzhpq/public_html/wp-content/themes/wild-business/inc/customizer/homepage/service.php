...
$wp_customize->add_section(
	'wild_business_service',
	array(
		'title' => esc_html__( 'service', 'wild-business' ),
...
$wp_customize->add_setting(
	'wild_business_service_sub_title',
	array(
		'sanitize_callback' => 'sanitize_text_field',
		'transport'	=> 'postMessage',
		'default'	=>  __('Our Services', 'wild-business'),
	)
);
...
$wp_customize->add_control(
	...
	array(
		...
		'active_callback' => 'wild_business_if_service_enabled',	
	)
);
...
$wp_customize->selective_refresh->add_partial( 
	...
	array(
		...
		'render_callback'     => 'wild_business_service_partial_sub_title',
	) 
);

$wp_customize->add_setting(
	'wild_business_service_title',
	array(
		'sanitize_callback' => 'sanitize_text_field',
		'transport'	=> 'postMessage',
		'default'	=>  __('Here is Our Awesome Services', 'wild-business'),
	)
);
...
$wp_customize->selective_refresh->add_partial( 
	...
	array(
		...
		'render_callback'     => 'wild_business_service_partial_title',
	) 
);
...
for ($i=1; $i <= 3; $i++) { 
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			=> 'dropdown-pages',
			'active_callback' => 'wild_business_if_service_page'
		)
	);
}