...
$team = get_theme_mod( 'wild_business_team', 'disable' );
$subtitle   = get_theme_mod('wild_business_team_sub_title',__('Our Members','wild-business') );
$team_title   = get_theme_mod('wild_business_team_title', __('Here is Our Awesome Team','wild-business') );
// Bail if the section is disabled.
if ( 'disable' === $team ) {
	return;
}

$get_content = wild_business_get_section_content( 'team', $team, 3 );
            ...
            <article>
                <div class="team-item-wrapper">
                    ...
                    <header class="entry-header">
                        <span class="team-position"><?php echo esc_html(get_theme_mod('wild_business_team_position_'.($i+1))); ?></span>
