...
$about = get_theme_mod( 'wild_business_about', 'disable' );
// Bail if the section is disabled.
if ( 'disable' === $about ) {
    return;
}

$sub_title    = get_theme_mod( 'wild_business_about_sub_title', __( 'About Us', 'wild-business') ) ;
$get_content = wild_business_get_section_content( 'about', $about, 1  );
?>
