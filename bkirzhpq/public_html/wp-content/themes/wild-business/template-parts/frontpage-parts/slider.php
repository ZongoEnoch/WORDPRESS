...
$slider = get_theme_mod( 'wild_business_slider', 'disable' );
// Bail if the section is disabled.
if ( 'disable' === $slider ) {
	return;
}

$slider_btn    = get_theme_mod( 'wild_business_slider_button_label', __( 'Learn More', 'wild-business') );

$get_content = wild_business_get_section_content( 'slider', $slider, 3  );
?>
